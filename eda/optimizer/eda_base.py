...
class EDABase(metaclass=ABCMeta):
    ...
    def sampling(self):
        ...
        #print("resta = ", cum_theta - self.theta)

        # if bin_to_float(1 * c[:, 1][0:10]) < 0.7 or bin_to_float(1 * c[:, 1][0:10]) > 3:
        #     ready = 0
        # elif bin_to_float(1 * c[:, 1][10:20]) < 0.7 or bin_to_float(1 * c[:, 1][10:20]) > 3:
        #     ready = 0
        # elif bin_to_float(1 * c[:, 1][20:30]) < 0.7 or bin_to_float(1 * c[:, 1][20:30]) > 3:
        #     ready = 0
        # elif bin_to_float(1 * c[:, 1][30:40]) < 0.7 or bin_to_float(1 * c[:, 1][30:40]) > 3:
        #     ready = 0
        # else:
        #     ready = 1
